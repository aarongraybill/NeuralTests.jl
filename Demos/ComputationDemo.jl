...
net = n.Network()
n.add_node!(net,"input")
n.add_node!(net,"output1")
n.add_edge!(net,"input","output1",5.0) # ensure these strings uniquely identify a node
n.add_node!(net,"output2")
n.add_node!(net,"hidden",[("input",1.0)],[("output1",1.5),("output2",2.5)])
...
n.add_node!(simple_net,"input1")
n.add_node!(simple_net,"input2")
n.add_node!(simple_net,"outputA")
n.add_node!(simple_net,"outputB")
